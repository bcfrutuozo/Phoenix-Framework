// Auto-generated: UnicodeCase_generated.hpp
...
static constexpr MapPair LOWER_MAP[1488] = {
    { 0x0041, 0x0061 },
    { 0x0042, 0x0062 },
    { 0x0043, 0x0063 },
    { 0x0044, 0x0064 },
...
constexpr std::size_t map_find(const MapPair* arr, std::size_t n, uint32_t cp) noexcept {
